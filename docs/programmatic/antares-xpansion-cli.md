...
| `benders`            | Solve the investment optimization problem of Antares Xpansion, using the [benders decomposition](../reference/xpansion-theory.md#benders-reformulation-and-decomposition-algorithm). |
...
| `study_update`       | Update the Antares study with the solution returned by the [benders decomposition](../reference/xpansion-theory.md#benders-reformulation-and-decomposition-algorithm) algorithm.     |
...
| `presolve`           | Launch a presolver on the decomposed problem (only available with Xpress solver). See [calling the presolve](../reference/xpansion-intro.md#calling-the-presolve) |
