...
| --economy                           | Force the simulation in [economy](../reference/config-general.md#enum-building-mode) mode                                                                                                                                       |
| --adequacy                          | Force the simulation in [adequacy](../reference/config-general.md#enum-building-mode) mode                                                                                                                                      |
| --parallel                          | Enable [parallel](../reference/config-advanced-parameters.md/#enum-simulation-cores) computation of MC years                                                                                                                     |
...
| -y, --year=VALUE         | Override the [number of MC years](../reference/config-general.md#int-number)                                            |
| --year-by-year           | Force the [writing the result output for each year](../reference/config-general.md#bool-year-by-year) (economy only) |
...
| command                  | usage                                                                                                                                                                                                                                                                                     |
|:-------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --optimization-range     | Force the [simplex optimization range](../reference/config-optimization.md#enum-simplex-optimization-range) ('day' or 'week')                                                                                                                                                                                                  |
